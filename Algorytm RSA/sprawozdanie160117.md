...
- p = 12## Implementacja algorytmu RSA
...
Wiadomość została podzielona na 3-znakowe bloki tekstu.Zastosowanie bloków ukrywa częstotliwość występowania pojedynczych znaków, co znacząco zwiększa bezpieczeństwo przed prostą kryptoanalizą.
